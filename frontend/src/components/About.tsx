    ...
    <section className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-24 items-center">
        ...
        <div className="order-1 lg:order-2">
          ...
          >
            A Community Legacy.<br />Mastered to a Higher Degree.
          </motion.h2>
          ...
          >
            <p className="text-base sm:text-lg text-brand-earth leading-relaxed mb-8 sm:mb-10 font-medium tracking-tight">
              We define excellence through rigorous selection. Our collection is hand-vetted for the most refined palates, ensuring every visit to our Salisbury Way location is a masterclass in boutique cannabis. Experience the standard, daily until 2 AM.
            </p>
            <Link
              to="/about"
