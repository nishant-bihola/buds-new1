    ...
    <div className="pt-28 sm:pt-32 bg-brand-earth overflow-x-hidden">
      ...
      <section className="px-6 py-24 sm:py-32">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            We started as friends who wanted better quality and honest prices. Sherwood Park's most trusted dispensary — open every day until 2 AM.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            >
              ...
              <p>
                Every product on our shelf has been hand-selected by our team. We test it, love it, and only then share it with you. No fillers, no gimmicks.
              </p>
              <p>
                We're open 365 days a year until 2 AM because our community deserves a shop that works around their schedule.
              </p>
              <Link
                to="/contact"
                className="mt-12 inline-flex items-center gap-4 bg-brand-green text-brand-earth px-10 py-5 rounded-full text-sm font-black uppercase tracking-widest hover:bg-brand-light-green hover:text-brand-green transition-all shadow-2xl shadow-brand-green/20"
              >
                Get in Touch
