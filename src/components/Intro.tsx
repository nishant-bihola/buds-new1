        ...
        <div className="order-2 lg:order-1">
          ...
          >
            <p className="text-lg sm:text-xl text-brand-earth leading-relaxed mb-10 font-medium tracking-tight max-w-xl">
              We cut the fluff to give Sherwood Park the best prices. Whether it's a holiday or a Tuesday night, we're here for you. Open every single day until 2 AM.
            </p>
            <div className="p-8 bg-brand-earth/30 rounded-[40px] border border-brand-green/5 backdrop-blur-sm shadow-inner">
              <p className="text-brand-green font-black uppercase tracking-tight text-xl sm:text-2xl italic leading-tight">
