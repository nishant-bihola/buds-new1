...
const DEFAULT_DB: DB = {
  products: [
    { id: "flower-01", name: "Nano Banana Kush", price: 35.0, image: "/images/nano_banana_kush.png", category: "Dried Flower", description: "Ultra-smooth, high potency, tropical banana notes. A perfectly crafted hybrid from BC's finest cultivators.", thc: "28%", cbd: "0.1%", terpenes: ["Myrcene", "Limonene", "Caryophyllene"], brand: "Endgame", weight: "3.5g", strain: "Hybrid", inStock: true, quantity: 50, isBestSeller: true, sortOrder: 1 },
    { id: "flower-02", name: "Island Pink Kush", price: 32.0, image: "/images/island_pink_kush.png", category: "Dried Flower", description: "Classic BC bud. Heavy resin, deep body relaxation, floral sweetness.", thc: "24%", cbd: "0.1%", terpenes: ["Linalool", "Myrcene", "Pinene"], brand: "Purple Hills", weight: "3.5g", strain: "Indica", inStock: true, quantity: 42, isBestSeller: false, sortOrder: 2 },
    { id: "edible-01", name: "Sour Peach Rings", price: 19.99, image: "/images/sour_peach_rings.png", category: "Edible", description: "Consistent THC dosing, fan favourite. Classic sour peach candy with a kick.", thc: "10mg", cbd: "0mg", brand: "BoxHot", inStock: true, quantity: 100, isBestSeller: true, sortOrder: 3 },
    { id: "preroll-01", name: "Back Forty Pre-Roll Pack", price: 24.99, image: "/images/preroll.png", category: "Pre-Roll", description: "Ready-to-spark pre-rolls from the award-winning Back Forty farm.", thc: "22%", brand: "Back Forty", weight: "3×0.5g", strain: "Hybrid", inStock: true, quantity: 35, isBestSeller: false, sortOrder: 4 },
    { id: "vape-01", name: "Spinach Disposable Vape", price: 44.99, image: "/images/vape.png", category: "Vape", description: "Sleek, pocket-friendly disposable. Berry Creamsicle flavour. Sativa-forward uplift.", thc: "85%", cbd: "0%", brand: "Spinach", strain: "Sativa", inStock: true, quantity: 20, isBestSeller: false, sortOrder: 5 },
    { id: "concentrate-01", name: "Dab Bods Live Resin", price: 54.99, image: "/images/concentrate.png", category: "Concentrate", description: "High-terpene live resin extract. Bold, pungent, full-spectrum experience.", thc: "70%", cbd: "0.5%", terpenes: ["Terpinolene", "Ocimene", "Myrcene"], brand: "Dab Bods", weight: "1g", inStock: true, quantity: 15, isBestSeller: false, sortOrder: 6 },
  ],
  orders: [],
  customers: [],
  automations: [
